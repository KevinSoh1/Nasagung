    ...
    <style>
  	...
  	a:active {
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-welcome strong { color: var(--white); }
        ...
        .intro-text { text-align: center; margin-top: -300px; margin-bottom: 40px; }
        ...
        .main-content-layout { display: flex; justify-content: center; align-items: center;
    ...
    <div class="hero-content">
        ...
        <?php 
        	if (isset($_SESSION['user_email'])){
        		include 'todayLockOn.php';
        	}         		
        	else{
        		include 'todayLockOff.php';
        	}
        ?>
        </div>
    </div>
...
document.getElementById('sajuForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('http://219.248.39.171:8000/todayLock', {
            method: 'POST',
            headers: {
