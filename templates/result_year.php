        ...
        <div class="mypage-layout mt-5">
            ...
            <div class="dashboard-section">
                <div class="history-card">
                    <h3>📜 <strong><?php echo htmlspecialchars($user['name']); ?>님의 2026년 신년운세 종합 분석 명반</strong></h3>
...
<script>
    function resultView(){
        ...
        const q = `${userName}(${genDer}, ${birthYear}년 ${birthDay}일 ${birthTime}시 생)에 대한 2026년 운세를 종합적으로 분석해주세요`;

        document.getElementById("result").innerText = "2026년 신년 명반을 분석하고 있습니다. 잠시만 기다려주세요...";
